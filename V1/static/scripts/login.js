...
function computeLoginURI() {
    return LOGIN_URL.concat("response_type=", LOGIN_RESPONSE_TYPE, "&redirect_uri=http://", location.host, LOGIN_REDIRECT_URI, "&client_id=", EVE_WANTED_ID, "&scope=", LOGIN_SCOPE, "&state=TODO");
}
